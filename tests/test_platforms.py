    ...
    def test_get_platform_adapter_windows(self):
        ...
        try:
            with patch("platform.system", return_value="Windows"):
                with patch("desktop_client.platforms.windows.WindowsPlatformAdapter") as mock_cls:
    ...
    def test_get_platform_adapter_macos(self):
        ...
        try:
            with patch("platform.system", return_value="Darwin"):
                with patch("desktop_client.platforms.macos.MacOSPlatformAdapter") as mock_cls:
                    mock_adapter = MagicMock()
    ...
    def test_get_platform_adapter_linux(self):
        ...
        try:
            with patch("platform.system", return_value="Linux"):
                with patch("desktop_client.platforms.linux.LinuxPlatformAdapter") as mock_cls:
                    mock_adapter = MagicMock()
