...
class PluginMetadata:
    ...
    dependencies: List[str] = field(default_factory=list, metadata={"description": "依赖插件列表"})
    min_app_version: Optional[str] = field(default=None, metadata={"description": "最低兼容版本"})
    max_app_version: Optional[str] = field(default=None, metadata={"description": "最高兼容版本"})
